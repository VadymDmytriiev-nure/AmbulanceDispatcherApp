namespace AmbulanceDispatcherApp.Forms.Hospital
{
    partial class HospitalsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            // column_hospital_name
            // 
            column_hospital_name.DataPropertyName = "hospital_name";
            column_hospital_name.HeaderText = "Назва";
            column_hospital_name.Name = "column_hospital_name";
            column_hospital_name.ReadOnly = true;
            column_hospital_name.Width = 75;
            // 
            // column_hospital_address
            // 
            column_hospital_address.DataPropertyName = "hospital_address";
            column_hospital_address.HeaderText = "Адреса";
            column_hospital_address.Name = "column_hospital_address";
            column_hospital_address.ReadOnly = true;
            column_hospital_address.Width = 84;
            // 
            // column_hospital_specialization
            // 
            column_hospital_specialization.DataPropertyName = "hospital_specialization";
            column_hospital_specialization.HeaderText = "Спеціалізація";
            column_hospital_specialization.Name = "column_hospital_specialization";
